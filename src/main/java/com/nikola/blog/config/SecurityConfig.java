package com.nikola.blog.config;

import com.nikola.blog.security.JwtAuthenticationEntryPoint;
import com.nikola.blog.security.JwtAuthenticationFilter;
 ...
 /*   @Bean
    public UserDetailsService userDetailsService(){
        ...
        UserDetails admin = User.builder()
                ...
                .roles("ADMIN")
                .build();
        return new InMemoryUserDetailsManager(nikola,admin);
    }*/
}
